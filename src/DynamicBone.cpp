...
MTypeId DynamicBone::s_id(0x7b001);

MObject DynamicBone::s_enable;

MObject DynamicBone::s_time;
MObject DynamicBone::s_resetTime;
MObject DynamicBone::s_fps;

MObject DynamicBone::s_offsetMatrix;
MObject DynamicBone::s_offsetMatrixWeight;

MObject DynamicBone::s_boneTranslate;
MObject DynamicBone::s_boneJointOrient;
MObject DynamicBone::s_boneParentMatrix;
MObject DynamicBone::s_boneParentInverseMatrix;
MObject DynamicBone::s_endTranslate;

MObject DynamicBone::s_rotationOffset;

MObject DynamicBone::s_boneScale;
MObject DynamicBone::s_boneInverseScale;
MObject DynamicBone::s_endScale;

MObject DynamicBone::s_damping;
MObject DynamicBone::s_elasticity;
MObject DynamicBone::s_elasticForceFunction;
MObject DynamicBone::s_stiffness;
MObject DynamicBone::s_mass;
MObject DynamicBone::s_gravityMultiply;
MObject DynamicBone::s_gravity;
MObject DynamicBone::s_additionalForce;
MObject DynamicBone::s_additionalForceScale;

MObject DynamicBone::s_enableTurbulence;
MObject DynamicBone::s_turbulenceSeed;
MObject DynamicBone::s_turbulenceStrength;
MObject DynamicBone::m_turbulenceVectorChangeScale;
MObject DynamicBone::m_turbulenceVectorChangeMax;

MObject DynamicBone::s_enableAngleLimit;
MObject DynamicBone::s_angleLimit;

MObject DynamicBone::s_radius;

MObject DynamicBone::s_iterations;

MObject DynamicBone::s_enableGroundCol;
MObject DynamicBone::s_groundHeight;

MObject DynamicBone::s_sphereCollider; 
MObject DynamicBone::s_sphereColMtx;
MObject DynamicBone::s_sphereColRad;

MObject DynamicBone::s_capsuleCollider;
MObject DynamicBone::s_capsuleColMtxA;
MObject DynamicBone::s_capsuleColMtxB;
MObject DynamicBone::s_capsuleColRadA;
MObject DynamicBone::s_capsuleColRadB;

MObject DynamicBone::s_iPlaneCollider;
MObject DynamicBone::s_iPlaneColMtx;

MObject DynamicBone::s_meshCollider;
MObject DynamicBone::s_meshColCutoff;

MObject DynamicBone::s_outputRotate;

DynamicBone::DynamicBone() : m_init(true), m_lastSeed(-1), m_lastFrame(-1) {
    m_rngState[0] = 0;
    m_rngState[1] = 0;
    m_rngState[2] = 0;
    m_rngState[3] = 0;
...
void* DynamicBone::creator()
{
    return new DynamicBone;
}

DynamicBone::SchedulingType DynamicBone::schedulingType() const
{
    return kParallel;
}

void DynamicBone::getCacheSetup(const MEvaluationNode& evalNode, MNodeCacheDisablingInfo& disablingInfo, MNodeCacheSetupInfo& cacheSetupInfo, MObjectArray& monitoredAttributes) const
{
    bool enabled = false;
    MStatus status;
    ...
    if (enabled) {
        ...
        disablingInfo.setReason("DynamicBone does not support cached playback.");
    }
...
MStatus DynamicBone::initialize()
{
...
double DynamicBone::degToRad(double deg)
{
    return deg * (M_PI / 180);
}

void DynamicBone::angleLimit(const MVector& pivot, const MVector& a, MVector& b, const double limitAngle)
{
...
void DynamicBone::distanceConstraint(const MVector& pivot, MVector& point, double distance)
{
    // update point
    point = pivot + ((point - pivot).normal() * distance);
}

void DynamicBone::getClosestPoint(const MObject& mesh, const MPoint& point, MPoint& closestPoint, MVector& closestNormal)
{
    MFnMesh fnMesh(mesh);
    fnMesh.getClosestPointAndNormal(point, closestPoint, closestNormal, MSpace::kWorld);
}

uint32_t DynamicBone::rotl(const uint32_t x, int k) {
    return (x << k) | (x >> (32 - k));
}

double DynamicBone::rand_double(const double scale) {
...
MStatus DynamicBone::compute(const MPlug& plug, MDataBlock& data)
{
